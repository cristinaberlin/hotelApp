...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference("Hotel.count") do
      post hotels_url, params: { hotel: { email: @hotel.email, full_name: @hotel.full_name, name_room: @hotel.name_room, price: @hotel.price } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { email: @hotel.email, full_name: @hotel.full_name, name_room: @hotel.name_room, price: @hotel.price } }
